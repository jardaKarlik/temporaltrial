...
export function loadTeknoConfig() {
    const prodUrl = optional('TEKNO_PROD_URL', 'https://tekno.up.railway.app');
    const stagingServiceId = optional('RELEASES_STAGING_SERVICE_ID', optional('RELEASES_SERVICE_ID', '39ab8724-a7a5-4162-b585-cb7779194bf3'));
    const prodServiceId = optional('RELEASES_PROD_SERVICE_ID', optional('RELEASES_SERVICE_ID', '39ab8724-a7a5-4162-b585-cb7779194bf3'));
    return {
        ...
        releasesProjectId: optional('RELEASES_PROJECT_ID', 'ce27c333-68c0-4d53-a139-1688261d3452'),
...
export function requireDiscordWebhook() {
